...
export abstract class BaseResourceFormComponent<T extends BaseResourceModel>
      ...
      this.route.paramMap
        ...
        .subscribe(
          resource => {
            ...
            // binds loade resource data to ResourceForm
  ...
  protected setPageTitle() {
    if (this.currentAction === 'new') {
      this.pageTitle = this.creatingPageTitle();
    } else {
  ...
  actionsForSuccess(resource: T) {
    toastr.success('Solicitaçã processada com sucesso.');
